...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Uzythcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"uzythcointools.com", "3.8.60.201"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"uzythcointools.com", "testnet-seed.uzythcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Uzythcoin is probably already running."), addrBind.ToString().c_str());
        else
